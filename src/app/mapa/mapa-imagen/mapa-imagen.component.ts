...
export class MapaImagenComponent implements OnInit, AfterViewInit {
  ...
  cities: { name: string; group: number; x: number; y: number; connections: string[] }[] = [
    ...
    { name: 'Pekin', group: 0, x: 1380, y: 275, connections: ['Shanghai', 'Seul'] },
    { name: 'Seul', group: 0, x: 1430, y: 320, connections: ['Pekin', 'Tokio'] },
    { name: 'Tokio', group: 0, x: 1470, y: 300, connections: ['Seul', 'Osaka', 'San Francisco'] },
    { name: 'Osaka', group: 0, x: 1460, y: 320, connections: ['Tokio', 'Taipei'] },
